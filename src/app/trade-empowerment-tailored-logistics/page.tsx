      ...
      <div className="mx-auto max-w-[1440px] px-4 py-6 md:px-6 lg:px-8">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Pilot Program: Pelabuhan Tanjung Priok • Week 14</p>
          </div>
          <div className="flex items-center gap-3">
            <div className="rounded-lg bg-white/70 px-3 py-1.5 text-xs font-medium text-black shadow-sm backdrop-blur-sm">
              Live view
            </div>
            <button className="bg-[#0475bc] hover:bg-[#0475bc]/90 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
              + Tambah UMKM
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-6">
          ...
          <div className="lg:col-span-4">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              <Card className="p-4 transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl cursor-pointer">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          {/* Shipments Chart */}
          <Card className="lg:col-span-2 transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl cursor-pointer">
            <CardHeader>
              <CardTitle className="text-lg font-semibold text-[#0475bc]">Shipments & Volume (last 12 weeks)</CardTitle>
              ...
              <div className="h-64 bg-gray-50 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  <div className="text-4xl mb-2">📊</div>
                   <p className="text-black text-sm">Line Chart: Shipments (count) & Tonnage (MT)</p>
                   <p className="text-xs text-black mt-1">W-1 to W-12 data visualization</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          {/* Cold Chain Health */}
          <Card className="transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl cursor-pointer">
            <CardHeader>
              <CardTitle className="text-lg font-semibold text-[#0475bc]">Cold Chain Health</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="h-64 bg-gray-50 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  <div className="relative w-32 h-32 mx-auto mb-4">
                    ...
                    <div className="absolute inset-0 rounded-full bg-orange-200" style={{clipPath: 'polygon(50% 50%, 50% 0%, 100% 0%, 100% 100%, 0% 100%, 0% 0%, 50% 0%)'}}></div>
                  ...
                  <div className="flex justify-center gap-4 text-sm">
                   ...
                   <p className="text-xs text-black mt-2">Temp breaches: 3 in last 7 days</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          {/* UMKM List */}
          <Card className="lg:col-span-2 transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-lg">
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle className="text-lg font-semibold text-[#0475bc]">Daftar UMKM Terdaftar</CardTitle>
                <div className="flex items-center gap-2">
                  <input 
                    type="text" 
                    placeholder="Cari UMKM..." 
                    className="px-3 py-1 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0475bc]"
                  />
                  <button className="bg-[#0475bc] text-white px-3 py-1 rounded-lg text-sm">
                    Filter
                  </button>
                </div>
              </div>
            ...
            <CardContent>
              <div className="space-y-3">
                {umkmData.map((umkm, index) => (
                  <div key={index} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 hover:-translate-y-1 hover:shadow-md transition-all duration-300 ease-in-out cursor-pointer">
                    <div className="flex items-center justify-between hover:bg-gray-50 p-2 rounded-lg transition-all duration-300 ease-in-out cursor-pointer">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-[#0475bc] text-white rounded-full flex items-center justify-center text-sm font-bold">
                          {umkm.id.split('-')[1]}
                        </div>
                        <div>
                           <h3 className="font-semibold text-black">{umkm.name}</h3>
                           <p className="text-sm text-black">{umkm.location} • {umkm.category}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-right">
                          <div className={`text-xs px-2 py-1 rounded-full ${
                            umkm.status === 'Active' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'
                          }`}>
                            {umkm.status}
                          </div>
                           <div className="text-xs text-black mt-1">{umkm.lastShipment}</div>
                        </div>
                        <button className="text-[#0475bc] hover:text-[#0475bc]/80 text-sm">
                          Detail →
                        </button>
                      </div>
                    </div>
                    <div className="mt-3 flex flex-wrap gap-2">
                      {umkm.products.map((product, idx) => (
                         <span key={idx} className="text-xs bg-gray-100 text-black px-2 py-1 rounded">
                          {product}
                        </span>
                      ))}
                    </div>
          ...
          <Card className="transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-lg">
            <CardHeader>
              <CardTitle className="text-lg font-semibold text-[#0475bc]">Aktivitas Terbaru</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                {recentActivities.map((activity, index) => (
                  <div key={index} className="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-50 hover:-translate-y-1 hover:shadow-sm transition-all duration-300 ease-in-out cursor-pointer">
                    ...
                    <div className="flex-1">
                       ...
                       <p className="text-xs text-black mt-1">{activity.time}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          ...
          <Card className="transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl cursor-pointer">
            ...
            <CardContent>
              <div className="space-y-2">
                <button className="w-full text-left p-3 rounded-lg hover:bg-gray-50 hover:-translate-y-1 hover:shadow-sm transition-all duration-300 ease-in-out">
                  <div className="flex items-center gap-3">
                    <div className="text-2xl">📊</div>
                    <div>
                       <div className="font-medium text-sm text-black">Generate Report</div>
                ...
                <button className="w-full text-left p-3 rounded-lg hover:bg-gray-50 hover:-translate-y-1 hover:shadow-sm transition-all duration-300 ease-in-out">
                  <div className="flex items-center gap-3">
                    <div className="text-2xl">📧</div>
                    <div>
                       <div className="font-medium text-sm text-black">Send Notification</div>
                ...
                <button className="w-full text-left p-3 rounded-lg hover:bg-gray-50 hover:-translate-y-1 hover:shadow-sm transition-all duration-300 ease-in-out">
                  <div className="flex items-center gap-3">
                    <div className="text-2xl">💰</div>
                    <div>
                       <div className="font-medium text-sm text-black">Process Payment</div>
          ...
          <Card className="transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl cursor-pointer">
            <CardHeader>
              <CardTitle className="text-lg font-semibold text-[#0475bc]">Performance Metrics</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl cursor-pointer">
            <CardHeader>
              <CardTitle className="text-lg font-semibold text-[#0475bc]">Alerts & Notifications</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-2 bg-red-50 rounded-lg hover:bg-red-100 hover:-translate-y-1 hover:shadow-sm transition-all duration-300 ease-in-out cursor-pointer">
                ...
                <div className="flex items-center gap-3 p-2 bg-yellow-50 rounded-lg hover:bg-yellow-100 hover:-translate-y-1 hover:shadow-sm transition-all duration-300 ease-in-out cursor-pointer">
                ...
                <div className="flex items-center gap-3 p-2 bg-blue-50 rounded-lg hover:bg-blue-100 hover:-translate-y-1 hover:shadow-sm transition-all duration-300 ease-in-out cursor-pointer">
